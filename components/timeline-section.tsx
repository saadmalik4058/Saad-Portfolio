  ...
  const timelineEvents = [
    {
      ...
      contributions: [
        ...
        "Learned and applied foundational state management with Mobx and Redux for small-scale projects.",
    ...
    },
    {
      ...
      contributions: [
        ...
        "Managed complex state with Mobx and Redux Toolkit for efficient data handling and synchronization.",
        "Integrated RESTful APIs for seamless frontend-backend data flow.",
        "Collaborated with UI/UX designers to translate design systems into fully functional, responsive components.",
        "Mentored junior developers and conducted code reviews to uphold code quality and promote a culture of learning and excellence.",
